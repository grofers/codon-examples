This directory should contain specification for service side components in jplaceholder. The following files/directories further classify the specifications:
